<?php
    ...
    if($conn){
        ...
        // $sql = "INSERT INTO product (product_title, product_img, product_content, product_poster, product_created) VALUES ('$title', '$filename', '$content', '$poster', '$created')";
        // $datas = mysqli_query($conn, $sql);
        
        // 改為使用 mysqli_prepare() 來執行指令較為安全
        $sql = "INSERT INTO product (product_sn, 
                                     product_type_id, 
                                     product_name, 
                                     product_img, 
                                     product_content, 
                                     product_price, 
                                     product_posted) VALUES (?, ?, ?, ?, ?, ?, ?)";
