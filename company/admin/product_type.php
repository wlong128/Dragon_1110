        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-12 text-end pb-3">
                    <a href="product_type_post.php" class="btn btn-info btn-sm">新增</a>
                    <a href="product.php" class="btn btn-success btn-sm">產品管理</a>
                </div>
                <div class="col-12">
                        ...
                        <?php
                            ...
                            if(mysqli_num_rows($datas)>0){
                                ...
                                while($row = mysqli_fetch_assoc($datas)){
                                    ...
                                    echo '<td><a href="product_type_edit.php?id='.$row['product_type_id'].'" class="btn btn-info">編輯</a>';
                                    echo '</tr>';
                                }
                            }
                        ?>
